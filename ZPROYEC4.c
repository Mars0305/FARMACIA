...
void actualizarProducto(void)
{
	...
	int opcion,invalido,repetido,puntos;
	int i,idx;
	char continuar;
		...
		switch (opcion)
		{
			case 1:
				do
				{
					...
					taparProducto(293,316,635,336);
					setcolor(YELLOW);
					outtextxy(100,323,"Ingrese el nuevo codigo: ");
					gotoxy(38,21); scanf(" %s", new.codigo);
					...
					for(i = 0;i < numproductos;i++)
					{
						if(strcmp(inventario[i].codigo,new.codigo) == 0)
						{
                        	taparProducto(293,316,635,336);
							setcolor(RED);
							outtextxy(305,323,"Codigo ya existente!");
							repetido = 1;
							getch();
						}
					}
				...
				strcpy(inventario[idx].codigo,new.codigo);
				break;
			case 2:
				do
				{
					...
					if (invalido)
					{
                    	taparProducto(293,316,635,336);
						setcolor(RED);
						outtextxy(305,323, "No ingrese numeros o simbolos");
						getch();
						continue;
					}
					...
					for (i = 0; i < numproductos; i++)
					{
						if (strcmp(inventario[i].nombre, new.nombre) == 0 || strlen(new.nombre) > 19)
						{
                            taparProducto(293,316,635,336);
							setcolor(RED);
							outtextxy(305,323, "Max 19 carac. y no repetido");
							repetido = 1;
							getch();
						}
					}
				...
				strcpy(inventario[idx].nombre,new.nombre);
				break;
			case 3:
				do
				{
					invalido = 0;
					taparProducto(314,316,635,336);
					setcolor(YELLOW);
					...
					if(invalido)
					{
						taparProducto(314,316,635,336);
						setcolor(RED);
						outtextxy(315,323,"Cantidad no valida!");
						setcolor(WHITE);
						getch();
					}
   				...
   				inventario[idx].cantidad = atoi(cantidad);
				break;
			case 4:
				do
				{
					...
					if (invalido)
					{
                    	taparProducto(293,316,635,336);
						setcolor(RED);
						outtextxy(305,323,"Precio no valido!");
						setcolor(WHITE);
						getch();
					}
					...
					inventario[idx].precio = atof(precio);
					break;
			case 5:
			...
			case 6:
				do
				{
					...
					if(strlen(new.descripcion) > 36)
					{
						taparProducto(245,316,635,336);
						setcolor(RED);
						outtextxy(256,323,"Max. 36 caracteres");
						getch();
					}

				} while(strlen(new.descripcion) > 36);

				strcpy(inventario[idx].descripcion, new.descripcion);
				break;
			case 7:
				...
				do
				{
					...
					taparProducto(133,334,153,350);
                    taparProducto(133,334,635,350);

					setcolor(YELLOW);
					outtextxy(100,342,"Dia: ");;
					gotoxy(18,22); scanf(" %s",&new.dia);
					...
					if(strlen(new.dia) != 2 || invalido)
					{
						taparProducto(133,334,635,350);
						setcolor(RED);
						outtextxy(144,342,"Fecha no valida. Formato 00/00/0000");
						getch();
					}
					...
					if(atoi(new.dia) > 31 || atoi(new.dia) < 1)
					{
						taparProducto(133,334,635,350);
						setcolor(RED);
						outtextxy(144,342,"Ese dia no existe. Ingrese uno valido");
						getch();
					}
    				...
    				do
				{
					...
					taparProducto(187,334,210,350);
                    taparProducto(187,334,635,350);

					setcolor(YELLOW);
					outtextxy(156,342,"Mes: ");
					gotoxy(25,22); scanf(" %s",&new.mes);
					...
					if(strlen(new.mes) != 2 || invalido)
					{
						taparProducto(187,334,635,350);
						setcolor(RED);
						outtextxy(200,342,"Fecha no valida. Formato 00/00/0000");
						getch();
					}
					...
					if(atoi(new.mes) > 12 || atoi(new.mes) < 1)
					{
						taparProducto(187,334,635,350);
						setcolor(RED);
						outtextxy(200,342,"Ese mes no existe. Ingrese uno valido");
						getch();
					}
   				...
   				do
				{
					...
					taparProducto(252,334,292,351);
                    taparProducto(252,334,635,350);

					setcolor(YELLOW);
					outtextxy(212,342,"Year: ");
					gotoxy(33,22); scanf(" %s",&new.year);
					...
					if(strlen(new.year) != 4 || invalido)
					{
						taparProducto(252,334,635,350);
						setcolor(RED);
						outtextxy(264,342,"Fecha no valida. Formato 00/00/0000");
						getch();
					}
					...
					if(atoi(new.year) < 2025)
					{
						taparProducto(252,334,635,350);
						setcolor(RED);
						outtextxy(264,342,"Al menos debe vencer a partir de 2025");
						getch();
					}

				} while(strlen(new.year) != 4 || atoi(new.year) < 2025);

				strcpy(inventario[idx].dia, new.dia);
				strcpy(inventario[idx].mes, new.mes);
				strcpy(inventario[idx].year, new.year);
				break;
			default:
				setcolor(RED);
				outtextxy(100,323,"Opcion no valida!");
...
void venderProducto(void)
{
	...
	char referencia[LONG], cantidad[10],cant[10],credito[10],precio[10], total[10],fact[10];
	...
	if (index != -1)
	{
		...
		do
		{
			...
			if (indexcl != -1)
			{
				...
				setcolor(MAGENTA);
				outtextxy(90,278,"CLIENTE: ");
				outtextxy(180,278,clientes[indexcl].name);

				sprintf(credito,"%.2f",clientes[indexcl].credito);
				outtextxy(350,278,"CRED: C$");
				outtextxy(422,278,credito);
				setcolor(WHITE);
				...
				do
				{
					do
					{
						...
						{
							setcolor(RED);
							outtextxy(150, 370, "Cantidad de producto invalida!");
							getch();
						}

					} while(insuficiente);

					cant_vender = atoi(cant);
...
{
	Cliente new;
	char referencia[LONG],entrada[LONG],cred[10],credit[10];
	int opcion,invalido,repetido,puntos;
	int i,idx,len;
	char continuar;
	float credito = 0.00;
	...
	do
	{
		do
		{
			...
			switch (opcion)
			{
				...
				do
				{
					taparCliente(294,305,635,336);

					setcolor(YELLOW);
					outtextxy(100,307,"Ingrese el nuevo codigo: ");
					gotoxy(38,20);  scanf(" %s",new.code);
					...
					for(i = 0;i < numclientes;i++)
					{
						if(strcmp(clientes[i].code,new.code) == 0)
						{
							taparCliente(294,305,635,336);
							setcolor(RED);
							outtextxy(304,307,"Codigo ya existente!");
							repetido = 1;
							getch();
						}
						else
				...
				strcpy(clientes[idx].code,new.code);
				break;
				...
				do
				{
					...
					if (invalido)
					{
						taparCliente(294,305,635,336);
						setcolor(RED);
						outtextxy(304, 307, "No ingrese numeros o simbolos");
						getch();
						continue;
					}
					...
					for (i = 0; i < numclientes; i++)
					{
						if (strlen(new.name) > 19)
						{
							taparCliente(294,305,635,336);
							setcolor(RED);
							outtextxy(304,307, "Max 19 caracacteres");
							repetido = 1;
							getch();
						}
					}
				...
				strcpy(clientes[idx].name,new.name);
				break;
				...
				{
					invalido = 0;
					taparCliente(318,305,635,336);
					setcolor(YELLOW);
					outtextxy(100,307,"Ingrese el nuevo telefono: ");
					gotoxy(41,20); scanf(" %s", new.telefono);
					...
					if(invalido)
					{
						taparCliente(318,305,635,336);
						setcolor(RED);
						outtextxy(332,307,"Solo numeros y 8 dig.");
						setcolor(WHITE);
						getch();
					}
				...
				strcpy(clientes[idx].telefono, new.telefono);
				break;
				...
				do
				{
					...
					taparCliente(294,305,635,336);
					setcolor(YELLOW);
					outtextxy(100,307,"Ingrese el nuevo Gmail: ");
					gotoxy(38,20); scanf(" %[^\n]", new.correo);
					...
					for(i = 0; i < len;i++)
					{
						if(new.correo[i] == ' ')
						{
							taparCliente(294,305,635,336);
							setcolor(RED);
							outtextxy(305,307,"No contener espacios");
							setcolor(WHITE);
							invalido = 1;
							getch();
							break;
						...
						if(strcmp(new.correo,clientes[i].correo) == 0)
						{
							taparCliente(294,305,635,336);
							setcolor(RED);
							outtextxy(305,307,"Correo ya existente");
							setcolor(WHITE);
							invalido = 1;
							getch();
							break;
					...
					else if(len < 11)
					{
						taparCliente(294,305,635,336);
						setcolor(RED);
						outtextxy(305,307,"Min 1 caract. + dominio de Gmail");
						setcolor(WHITE);
						invalido = 1;
						getch();
					}
				...
				strcpy(clientes[idx].correo, new.correo);
				break;
				...
				do
				{
					...
					if(strlen(new.direccion) > 36)
					{
						taparCliente(318,305,635,336);
						setcolor(RED);
						outtextxy(325,307,"Max. 36 caracteres");
						getch();
					}

				} while(strlen(new.direccion) > 36);

				strcpy(clientes[idx].direccion, new.direccion);
				break;
				...
				do
				{
					...
					for (i = 0; credit[i] != '\0'; i++)
					{
						...
						else if (!isdigit(credit[i]) || credit[i] == ' ')
						{
							invalido = 1;
							break;
						}
					...
					if(credit[strlen(credit) - 1] == '.' || credit[0] == '.')
					{
						invalido = 1;
					}
					else if(atof(credit) <= 0)
					{
						invalido = 1;
					}
					...
					if (invalido)
					{
						taparCliente(360,300,635,336);
						setcolor(RED);
						outtextxy(368,307,"Ingrese una cantidad valida!");
						setcolor(WHITE);
						getch();
					}
