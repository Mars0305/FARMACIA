...
void verProducto(void)
{
	...
	if (numproductos == 0)
	{
	 ...
	 for (i = 0; i < numproductos; i++) {
		...
		sprintf(precio, "%.1f", pro.precio);
		outtextxy(214,Y + 18,"C$");
		outtextxy(228, Y + 18, precio);

		outtextxy(278, Y + 18, pro.unidad);
